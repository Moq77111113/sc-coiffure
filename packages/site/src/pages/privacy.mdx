...
Vous avez le droit d'accéder à vos informations personnelles et de demander des corrections si nécessaire. Pour exercer ces droits, veuillez nous contacter à {frontmatter.email}.
...
Si vous avez des questions concernant notre politique de confidentialité, veuillez nous contacter à {frontmatter.email}.
