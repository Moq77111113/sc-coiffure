        ...
        <div class="container px-4 md:px-6">
          <div class="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div class="flex flex-col justify-center space-y-4">
              <div class="space-y-4">
                <h1 class="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/tight">
                Sublimez votre style avec <span class="text-accent-foreground">SC Coiffure</span>
                </h1>
                <p class="max-w-[600px] md:text-xl">
                    Profitez des meilleurs soins capillaires de la région, offerts par notre équipe conviviale de coiffeurs passionnés.
                </p>
              </div>
            ...
            <img src="../../assets/hero.jpg" width="550" height="550" alt="Salon SC Coiffure"
