...
import colour from '~/assets/pictures/colour.jpg';
import haircut from '~/assets/pictures/haircut.jpg';
import highlights from '~/assets/pictures/highlights.jpg';
        ...
        <div class="grid gap-8 py-4 min-[450px]:grid-cols-2 md:grid-cols-3">
          <template v-for="({ src, alt, name }, idx) in services" :key="name">
            ...
            'm-auto flex flex-col space-y-4',
            {
              ...
              <img loading="lazy" :src="src" :alt="alt" class="h-[256px]  hover:brightness-125 md:size-full" />
              <Link href="#" class="text-md mr-2 flex items-center self-start font-bold tracking-tighter">Voir les prix
