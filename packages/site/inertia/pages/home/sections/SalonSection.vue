...
<template>
  <section id="us" class="w-full py-12 md:py-24 lg:py-32">
    ...
    <div class="flex justify-center space-x-24">
      <article class="flex flex-col items-center justify-center space-y-4 text-center">
        <div class="space-y-6 flex flex-col items-center">
          ...
          <p class="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            nous nous engageons à créer des coupes et des couleurs qui vous ressemblent, en prenant
            soin de mettre en valeur vos traits individuels.
          </p>
      ...
      <article class="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
        <div
        ...
        >
          <img
            ...
            height="400"
            :alt="name"
            class="mx-auto aspect-square overflow-hidden rounded-full object-cover hover:grayscale transition-all duration-300 ease-in-out"
          />
